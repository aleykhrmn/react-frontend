                ...
                >
                  ...
                  <div >
                    <img
                      src="/images/aplas.png"
                      alt="Fotoğraf 1"
                      className="w-full h-full mx-10px object-cover rounded-none p-1"
                      style={{
                        height: "100%",
                        objectFit: "cover",
                        borderRadius: "0px",
                  ...
                  {/* İkinci Fotoğraf */}
                  <div className="h-[500px] px-2.5">
                    <img
                      src="/images/aplas.png"
                      alt="Fotoğraf 2"
                      className="w-full h-full object-cover rounded-none p-1"
                    />
                  </div>
